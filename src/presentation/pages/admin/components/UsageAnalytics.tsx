  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <div className="mt-4 flex items-center text-green-400 text-sm">
              ...
              <span>
                {systemStats.active_tenants} aktif
              </span>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-4 flex items-center text-gray-400 text-sm">
              ...
              <span>
                Ortalama {Math.round(systemStats.total_users / systemStats.total_tenants)} kullanıcı/müşteri
              </span>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-4 flex items-center text-purple-400 text-sm">
              ...
              <span>
                ₺{systemStats.arr?.toLocaleString('tr-TR') || 0} ARR
              </span>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-orange-400 text-sm font-medium">Deneme</span>
            </div>
            <div className="text-3xl font-bold text-white mb-1">
            ...
            <div className="mt-4 flex items-center text-orange-400 text-sm">
              ...
              <span>
                %{Math.round((systemStats.trial_tenants / systemStats.total_tenants) * 100)} oran
              </span>
            </div>
          </motion.div>
        </div>
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Son {timeRange === '7d' ? '7' : timeRange === '30d' ? '30' : '90'} gün
              </p>
            </div>
            <div className="w-12 h-12 bg-blue-500/20 rounded-xl flex items-center justify-center">
        ...
        >
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-white font-bold text-lg">245 GB / 500 GB</span>
            </div>
            <div className="w-full bg-white/10 rounded-full h-2">
              <div className="bg-gradient-to-r from-purple-500 to-pink-500 h-2 rounded-full" style={{ width: '49%' }}></div>
            </div>
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/10">
              <div>
      ...
      >
        ...
        <div className="space-y-4">
          {[
            { name: 'Acme Corporation', usage: 95, api: '125K', storage: '45 GB' },
            { name: 'TechStart Inc.', usage: 82, api: '98K', storage: '38 GB' },
            { name: 'Global Trade Co.', usage: 76, api: '87K', storage: '32 GB' },
            { name: 'Digital Solutions', usage: 68, api: '76K', storage: '28 GB' },
            { name: 'Innovation Labs', usage: 54, api: '62K', storage: '22 GB' },
          ].map((tenant, index) => (
            <div
              key={index}
