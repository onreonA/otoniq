...
export default function ROICalculatorSection() {
  ...
  const platformCost = monthlyRevenue > 500000 ? 10000 : monthlyRevenue > 200000 ? 5000 : 2000;
  const netBenefit = totalSavings - platformCost;
  const roi = ((totalSavings + estimatedSalesIncrease) / platformCost).toFixed(2);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            İşletmenizin büyüklüğüne göre Otoniq.ai'nin size sağlayacağı tasarrufu
            ve ROI'yi hesaplayın.
          </p>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8 md:p-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 p-6 rounded-xl border border-blue-200">
                ...
                <div className="text-xs text-gray-600">Aylık kazanılan zaman</div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                <div className="md:col-span-2">
                  ...
                  <p className="text-blue-100 mb-4">
                    ...
                    {estimatedSalesIncrease.toLocaleString('tr-TR')} satış artışı!
                  </p>
