      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex justify-between items-center h-20'>
          ...
          <nav className='hidden md:flex items-center space-x-8'>
            ...
            <Link
              to='/products'
              className='text-gray-300 font-medium hover:text-green-400 transition-colors cursor-pointer'
            >
            ...
            <Link
              to='/marketplace'
              className='text-gray-300 font-medium hover:text-orange-400 transition-colors cursor-pointer'
            >
