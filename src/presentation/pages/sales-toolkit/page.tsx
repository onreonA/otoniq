      ...
      <div id="email-templates" className="mb-12 scroll-mt-8">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              <h3 className="font-bold text-gray-900 mb-2">5. Referans İsteği</h3>
              <p className="text-sm text-gray-600 mb-2">
      ...
      <div id="phone-scripts" className="mb-12 scroll-mt-8">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-bold text-gray-900 mb-2">AÇILIŞ (10 saniye)</h3>
            ...
            <div>
              <h3 className="font-bold text-gray-900 mb-2">VALUE PROPOSITION (30 saniye)</h3>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="p-3 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-700">
                    → "Pilot programımız var, ilk 3 ay ücretsiz. Sonuçları görün,
                    sonra karar verin."
                  </p>
                </div>
              </div>
      ...
      <div id="linkedin" className="mb-12 scroll-mt-8">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          ...
          <div className="p-6 bg-indigo-50 rounded-lg border-l-4 border-indigo-600">
            ...
            <p className="text-gray-700 mb-4">
              [Şirket]'daki çalışmalarınızı LinkedIn'de takip ediyorum. E-ticaret
              alanındaki başarınız etkileyici!
            </p>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-4">
              Bizim müşterilerimiz (Fashion Store Turkey, Teknoloji Perakende) bu
              süreçleri AI ile otomatikleştirerek günde 4-6 saat kazanıyor.
            </p>
            <p className="text-gray-700 mb-4">
