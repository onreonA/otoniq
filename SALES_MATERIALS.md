# 📊 OTONIQ.AI - SATIŞ MATERYALLERİ

Pitch deck, one-pager, email templates ve satış dokümanları.
...
4. Veri Analizi Eksikliği
   → Hangi ürün sattığını bilmiyor
   → Kararlar sezgisel, data-driven değil

"E-ticaret sahipleri operasyonel işlerde boğuluyor,
büyümeye odaklanamıyor."
```
...
1️⃣ BAĞLANIN (5 dakika)
   → Shopify, ERP, Marketplaces
   → Tek tıkla entegrasyon

2️⃣ OTOMATİKLEŞTİRİN (10 dakika)
   → AI workflow'ları aktifleştir
   → Kuralları belirle

3️⃣ BÜYÜYÜN (Sınırsız)
   → Zaman kazanın
...
"Ürün listeleme süremizi %90 azalttık"
→ 4 saat → 20 dakika
→ Satışlar %35 arttı
Plan: Professional

Teknoloji Perakende A.Ş.
"Stok kayıplarımız %60 azaldı"
→ IoT monitoring ile
→ Yıllık ₺120K tasarruf
Plan: Enterprise

Organik Gıda Evi
"Sosyal medya maliyetimiz ₺0'a indi"
→ AI içerik üretimi ile
→ Engagement %150 arttı
Plan: Starter
...
"Türkiye'nin ilk AI-native e-ticaret
otomasyon platformu"
```
...
• SLA garantisi
• Dedicated manager
İdeal: Büyük işletmeler

✨ ÖZEL TEKLİF
• İlk 20 müşteri: %30 indirim
• 14 gün ücretsiz deneme
• Pilot program (3 ay ücretsiz)
```
...
"İşletmenizi otomatikleştirin,
büyümeye odaklanın!"
```

---

## 📄 **ONE-PAGER** (Tek Sayfa Özet)
...
• Ürün listeleme saatler alıyor
• Çoklu pazaryeri yönetimi kaotik
• Yüksek operasyonel maliyetler (₺20K-50K/ay)
• Stratejik işlere zaman kalmıyor
...
🤖 AI OTOMASYONU
• Ürün listeleme: 4 saat → 5 dakika (%98 hız)
• Sosyal medya: Otomatik içerik üretimi
• Müşteri destek: 7/24 AI bot (%80 otomasyon)

📊 AKILLI ANALİTİK
• Satış tahminleri (AI destekli)
• Anomali tespiti (proaktif uyarılar)
• Trend analizi (data-driven kararlar)

🔗 ENTEGRASYONLAR
• Marketplaces: Shopify, Trendyol, Hepsiburada, N11
• ERP: Odoo, SAP, custom
...
│ Tasarruf    │ ₺3,750/ay    │ ₺15,500/ay   │ ₺61,000/ay   │
│ ROI         │ 1.87x        │ 3.1x         │ 5.6x         │
│ İdeal       │ Yeni başlayan│ Büyüyen      │ Büyük        │
└─────────────┴──────────────┴──────────────┴──────────────┘
...
✓ 14 GÜN ÜCRETSİZ DENEME (Kredi kartı gerektirmez)
✓ DEMO RANDEVUSU (30 dakika, özelleştirilmiş)
✓ PİLOT PROGRAM (3 ay ücretsiz, ilk 5 müşteri)
...
### **Template 1: İlk İletişim (Cold Email)**

**Konu:** [İsim], E-ticaret operasyonlarınızı %90 hızlandırabilir miyiz?
...
Otoniq.ai ile bu süreçleri otomatikleştiren müşterilerimiz:
✓ %90 zaman tasarrufu yapıyor (4 saat → 20 dakika)
✓ Sosyal medya maliyetlerini ₺0'a indiriyor (AI içerik)
✓ Müşteri destek maliyetini %50 azaltıyor (AI bot)

Örnek: Fashion Store Turkey, aylık ₺5,000 ödeyerek ₺15,500 tasarruf ediyor.

30 dakikalık bir demo ile size nasıl yardımcı olabileceğimizi gösterebilir miyim?

Takvimimden uygun bir saat seçebilirsiniz:
[Calendly Link]

Veya 14 gün ücretsiz deneyebilirsiniz (kredi kartı gerektirmez):
[Signup Link]

İyi çalışmalar,
[İsim]
Otoniq.ai - Sales Team
📧 [email]
📞 [telefon]
```
...
📊 DEMO ÖZETİ:
• Mevcut durum: [X] pazaryeri, [Y] ürün, günde [Z] saat manuel iş
• Otoniq.ai ile: %[X] zaman tasarrufu, ₺[Y]/ay maliyet düşüşü
• Tahmini ROI: [X]x (ilk aydan itibaren)

💰 SİZİN İÇİN ÖZEL TEKLİF:
Plan: [Professional/Enterprise]
Normal Fiyat: ₺[X]/ay
Özel İndirim: %30 (ilk 6 ay) 🎁
İndirimli Fiyat: ₺[Y]/ay

✨ BONUS:
• 14 gün ücretsiz deneme
• Ücretsiz onboarding & eğitim
• İlk 3 ay öncelikli destek

📎 EK DÖKÜMANLAR:
• ROI Hesaplama Detayı (PDF)
• Özellik Karşılaştırması (PDF)
• Müşteri Referansları

🚀 SONRAKİ ADIMLAR:
1. Ücretsiz denemeye başla: [Link]
2. Ekibinizle paylaş: [One-pager PDF]
3. Sorularınızı sor: Bu emaile yanıt verin

Herhangi bir sorunuz var mı? Görüşmek ister misiniz?
...
### **Template 3: Ücretsiz Deneme Hatırlatma**
...
✓ [Y] sosyal medya içeriği oluşturdunuz
✓ [Z] müşteri sorusu otomatik yanıtlandı

Zaman tasarrufunuz: ~[X] saat 🎉

🤔 DEVAM ETMEK İSTER MİSİNİZ?

Deneme süresi bitmeden önce bir plana geçerseniz:
🎁 İlk ay %20 indirim
🎁 Ücretsiz onboarding
🎁 3 ay öncelikli destek

Planınızı seçin: [Link]
...
İyi çalışmalar,
[İsim]
Otoniq.ai - Customer Success
```

---

### **Template 4: Kayıp Müşteri Geri Kazanma**
...
💡 YENİ ÖZELLİKLER EKLEDİK:

Son 2 ayda eklediğimiz özellikler:
✓ [Yeni Özellik 1]
✓ [Yeni Özellik 2]
✓ [Yeni Özellik 3]
...
• İlk 3 ay %50 indirim
• Ücretsiz 1-1 onboarding
• Dedicated account manager

Bu teklif sadece 7 gün geçerli.

Tekrar başlamak ister misiniz? [Link]
...
Başarı hikayenizi diğer e-ticaret sahipleriyle paylaşır mısınız?

Sadece 5 dakika:
• Kısa bir video testimonial (veya yazılı)
• Otoniq.ai'yi nasıl kullandığınız
• Ne gibi sonuçlar aldığınız

KARŞILIĞINDA:
🎁 3 ay ücretsiz plan upgrade
🎁 Case study'nizde öne çıkarma
🎁 LinkedIn'de paylaşım

İlgilenir misiniz? [Link]

Teşekkürler,
[İsim]
Otoniq.ai - Marketing Team
```

---

## 📱 **LINKEDIN MESAJ TEMPLATE**
