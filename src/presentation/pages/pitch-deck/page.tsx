...
const PitchDeck = () => {
    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          items: ['Satış tahminleri', 'Fiyat optimizasyonu', 'Anomali tespiti'],
        },
        {
          title: 'Sosyal Medya',
          items: [
        ...
        {
          title: 'IoT & AR/VR',
          items: ['Sensor monitoring', '3D product viewer', 'Virtual try-on'],
          badge: 'Enterprise',
        },
      ],
    },
      ...
      comparisons: [
        {
          ...
          advantages: ['%98 daha hızlı', '%100 daha az hata', '7/24 çalışıyor'],
        },
        {
                ...
                >
                  ...
                  <ul className='space-y-2'>
                    {problem.items.map((item, i) => (
                      <li
                        key={i}
                        className='text-lg text-white/90 flex items-start'
                      >
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-900 to-gray-800'>
      {/* Slide Container */}
      <div
        className={`min-h-screen bg-gradient-to-br ${current.gradient} transition-all duration-500 pt-20`}
      >
        {renderSlide(current)}
      </div>
